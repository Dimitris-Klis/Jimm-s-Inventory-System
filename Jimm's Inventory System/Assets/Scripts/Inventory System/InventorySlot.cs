...
public class InventorySlot : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        ...
        //AudioManager.instance.Play("SlotHover");
    ...
    public void UpdateSlot()
    {
        ...
        if (slotType == SlotTypes.HotbarSend)
        {
            InventoryUIHandler.instance.hotbarSystem.UpdateHotbarSlot(hotbarIndex, this);
        }
        //if(slotType == SlotTypes.Hotbar)
        //{
        //    //Set HotbarIndex;
    ...
    private void Start()
    {
        ...
        if (slotProperties.ItemAmountText != null)
        {
            //slotProperties.ItemAmountText.font = SettingsManager.instance.SelectFont();
